        ...
        $(function () {
			...
			function CheckIfPostBackUpdate()
			{
				if ($("#UpdateShowMessage").val() == "YES")
				{
					...
					ShowMessage("The Bonfire Menu has been updated."); 
				}
...
<h2>Bonfire Menu</h2>
 <fieldset class="form-group">
    ...
    <input type="text" class="form-control" id="BonfireTitle" name="BonfireTitle" value="<?= $data2['Title']?>"  />
  </fieldset>
<fieldset class="form-group">
    <label for="firstName">Description</label>
    <input type="text" class="form-control" id="BonfireDescription" name="BonfireDescription" value="<?= $data2['Description']?>"   />
  </fieldset>
<fieldset class="form-group">
    <label for="firstName">Price</label>
    <input type="text" class="form-control" id="BonfirePrice" name="BonfirePrice" value="<?= $data2['Price']?>"   />
  </fieldset>
  ...
  <fieldset class="form-group">
   ...
   <div>
<div style="width:20%;float:left;"><input type="submit"  class="btn btn-primary" value="Save Bonfire" /></div>
<div id="messageDiv" class="alert alert-success" style="width:80%;display:none;float:right;"><strong>Success!</strong> <span id="userMessage">Bonfire Saved.</span></div>
</div>

  <input type="hidden" value="Bonfire" name="formName" />
    <input type="hidden" <?= $BonfireUpdated == 'ok' ? ' value="YES" ' : 'value=" "';?> id="UpdateShowMessage" />
  </div>
  </form>
</body>
</html>
